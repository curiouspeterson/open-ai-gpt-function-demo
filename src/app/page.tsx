        ...
        <div className="mt-2 mb-12 flex rounded-md shadow-sm w-[600px]">
          <div className="relative flex flex-grow items-stretch focus-within:z-10">
            <input
              ...
              placeholder="write a review of the book A Promised Land by barack obama in the style of a limerick"
              defaultValue="write a review of the book A Promised Land by barack obama in the style of a limerick"
